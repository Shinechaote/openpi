...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi0_mimicgen_robomimic_ph",
    ...
    TrainConfig(
        name="pi05_six_env_mimicgen",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False, 
                                   paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotLiberoDataConfig(
            repo_id="christian/six_env_mimicgen",
            base_config=DataConfig(prompt_from_task=True),
        ),
        freeze_filter=pi0_config.Pi0Config(pi05=True, action_horizon=10,
                             discrete_state_input=False,
        ...
        name="pi05_1k_six_env_mimicgen",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False, 
                                   paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotLiberoDataConfig(
            repo_id="christian/1000_demo_six_env_mimicgen",
            base_config=DataConfig(prompt_from_task=True),
        ),
        freeze_filter=pi0_config.Pi0Config(pi05=True, action_horizon=10,
                             discrete_state_input=False,
        ...
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False, 
                                   paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotLiberoDataConfig(
            repo_id="christian/2000_demo_six_env_mimicgen",
            base_config=DataConfig(prompt_from_task=True),
        ),
        freeze_filter=pi0_config.Pi0Config(pi05=True, action_horizon=10,
                             discrete_state_input=False,
        ...
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, discrete_state_input=False, 
                                   paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotLiberoDataConfig(
            repo_id="christian/long_horizon_mimicgen",
            base_config=DataConfig(prompt_from_task=True),
        ),
        freeze_filter=pi0_config.Pi0Config(pi05=True, action_horizon=10,
                             discrete_state_input=False,
